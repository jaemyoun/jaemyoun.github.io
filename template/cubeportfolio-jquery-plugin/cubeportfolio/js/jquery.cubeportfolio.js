...
(function($, window, document, undefined) {
    ...
    $.extend(CubePortfolio.prototype, {
        ...
        _display: function() {
            ...
            if (t.blocksObj.length) {
                t.localColumnWidth += t.blocksObj[0].widthInitial;
            }

            t.getColumnsType = ($.isArray(t.options.mediaQueries)) ? '_getColumnsBreakpoints' : '_getColumnsAuto';

            t._registerEvent('afterGridAdjustment', function () {
        ...
        _layout: function() {
            ...
            // trigger this event for expand caption so it can handle properly the animation
            t._triggerEvent('afterGridAdjustment');
...
(function($, window, document, undefined) {
    ...
    CubePortfolio.Plugins.AnimationClassic = function (parent) {
        ...
        if (!CubePortfolio.Private.modernBrowser || $.inArray(parent.options.animationType, ['quicksand', 'fadeOut', 'flipOut', 'flipBottom', 'scaleSides', 'skew', 'boxShadow']) < 0 || parent.blocksObj.length === 0) {
            return null;
        }
...
(function($, window, document, undefined) {
    ...
    CubePortfolio.Plugins.AnimationClone = function (parent) {
        ...
        if (!CubePortfolio.Private.modernBrowser || $.inArray(parent.options.animationType, ['fadeOutTop', 'slideLeft']) < 0 || parent.blocksObj.length === 0) {
            return null;
        }
...
(function($, window, document, undefined) {
    ...
    CubePortfolio.Plugins.AnimationCloneDelay = function(parent) {
        ...
        if (!CubePortfolio.Private.modernBrowser ||
            $.inArray(parent.options.animationType, ['3dflip', 'flipOutDelay', 'slideDelay', 'rotateSides', 'foldLeft', 'unfold', 'scaleDown', 'frontRow', 'rotateRoom']) < 0 || parent.blocksObj.length === 0) {
            return null;
        }
...
(function($, window, document, undefined) {
    ...
    CubePortfolio.Plugins.AnimationSequentially = function (parent) {
        ...
        if (!CubePortfolio.Private.modernBrowser || parent.options.animationType !== 'sequentially' || parent.blocksObj.length === 0) {
            return null;
        }
...
(function($, window, document, undefined) {
    ...
    CubePortfolio.Plugins.AnimationWrapper = function(parent) {
        ...
        if (!CubePortfolio.Private.modernBrowser ||
            $.inArray(parent.options.animationType, ['bounceLeft', 'bounceBottom', 'bounceTop', 'moveLeft']) < 0 || parent.blocksObj.length === 0) {
            return null;
        }
...
(function($, window, document, undefined) {
    ...
    function CaptionExpand(parent) {
        ...
        parent._registerEvent('initFinish', function() {
            ...
            parent.$obj.on('click.cbp', '.cbp-caption-defaultWrap', function(e) {
                ...
                if (parent.$ulClone) {
                    if (!parent.wrapperFront) { // is clone
                        var item = parent.$ul.find('.cbp-item').eq(defaultWrap.closest('.cbp-item').index()),
                            activeWrapOriginal = item.find('.cbp-caption-activeWrap');

                        if (caption.hasClass('cbp-caption-expand-open')) {
                            activeWrapOriginal.css('position', '');
                        } else {
                            activeWrapOriginal.css('position', 'relative');
                        }
                    }
                }
                ...
                requestAnimationFrame(function() {
                    ...
                    t.copyStyleToClone(defaultWrap, endStyle);
    ...
    CaptionExpand.prototype.copyStyleToClone = function(defaultWrap, endStyle) {
        var t = this,
            parent = t.parent;


        if (parent.$ulClone) {
            var index = defaultWrap.closest('.cbp-item').index(),
                ul;

            if (parent.wrapperFront) { // is ul
                ul = parent.$ulClone;
            } else { // is clone
                ul = parent.$ul;
            }

            var item = ul.find('.cbp-item').eq(index),
                caption = item.find('.cbp-caption'),
                activeWrap = item.find('.cbp-caption-activeWrap');
    ...
    CubePortfolio.Plugins.CaptionExpand = function(parent) {
        ...
        if (parent.options.caption !== 'expand' || parent.blocksObj.length === 0) {
            return null;
        }
...
(function($, window, document, undefined) {
    ...
    CubePortfolio.Plugins.BottomToTop = function (parent) {
        ...
        if (!CubePortfolio.Private.modernBrowser || parent.options.displayType !== 'bottomToTop' || parent.blocksObj.length === 0) {
            return null;
        }
...
(function($, window, document, undefined) {
    ...
    CubePortfolio.Plugins.FadeInToTop = function (parent) {
        ...
        if (!CubePortfolio.Private.modernBrowser || parent.options.displayType !== 'fadeInToTop' || parent.blocksObj.length === 0) {
            return null;
        }
...
(function($, window, document, undefined) {
    ...
    CubePortfolio.Plugins.LazyLoading = function (parent) {
        ...
        if (!CubePortfolio.Private.modernBrowser || (parent.options.displayType !== 'lazyLoading' && parent.options.displayType !== 'fadeIn') || parent.blocksObj.length === 0) {
            return null;
        }
...
(function($, window, document, undefined) {
    ...
    CubePortfolio.Plugins.DisplaySequentially = function (parent) {
        ...
        if (!CubePortfolio.Private.modernBrowser || parent.options.displayType !== 'sequentially' || parent.blocksObj.length === 0) {
            return null;
        }
